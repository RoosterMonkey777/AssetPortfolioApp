...
extension PreviewProvider {
    static var shared_dev:DeveloperPreview{
        return DeveloperPreview.shared_preview
    }
}
...
class DeveloperPreview{
    ...
    let crypto = CryptoModel(
        ...
        price_change_percentage_24h_in_currency: 3952.64,
        coinHoldings: 1.5
    )
